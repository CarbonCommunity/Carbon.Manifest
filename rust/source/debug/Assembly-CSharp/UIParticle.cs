...
public class UIParticle : BaseMonoBehaviour
{
	...
	{
		GameObject gameObject = Object.Instantiate (particleSource.gameObject);
		gameObject.transform.SetParent (spawnPosition, worldPositionStays: false);
		...
		gameObject.transform.SetParent (particleCanvas, worldPositionStays: true);
