...
public class HotAirBalloon : BaseCombatEntity, SamSite.ISamSiteTarget
{
	...
	public bool IsValidSAMTarget (bool staticRespawn)
	{
		...
		return IsFullyInflated && !BaseVehicle.InSafeZone (triggers, base.transform.position);
	}
