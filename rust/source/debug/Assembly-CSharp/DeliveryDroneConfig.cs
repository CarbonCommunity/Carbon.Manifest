...
public class DeliveryDroneConfig : BaseScriptableObject
{
	...
	public bool IsVendingMachineAccessible (VendingMachine vendingMachine, Vector3 offset, out RaycastHit hitInfo)
	{
		...
		Vector3 center = vector + Vector3.up * testHeight;
		if (Physics.BoxCast (center, halfExtents, Vector3.down, out hitInfo, vendingMachine.transform.rotation, testHeight, layerMask)) {
			return false;
		}
