...
public class F15 : BaseCombatEntity
{
	...
	public float GetDesiredAltitude ()
	{
		...
		height += TerrainMeta.HeightMap.GetHeight (vector);
		height += TerrainMeta.HeightMap.GetHeight (vector + Vector3.right * 50f);
		height += TerrainMeta.HeightMap.GetHeight (vector - Vector3.right * 50f);
		height += TerrainMeta.HeightMap.GetHeight (vector + Vector3.forward * 50f);
		height += TerrainMeta.HeightMap.GetHeight (vector - Vector3.forward * 50f);
