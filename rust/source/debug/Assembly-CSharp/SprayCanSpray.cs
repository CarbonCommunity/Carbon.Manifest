...
public class SprayCanSpray : DecayEntity, ISplashable
{
	...
	public override void OnDeployed (BaseEntity parent, BasePlayer deployedBy, Item fromItem)
	{
		...
		if (ConVar.Global.MaxSpraysPerPlayer > 0 && sprayedByPlayer != 0) {
			int num = -1;
	...
	{
		return player.GetHeldEntity () != null && player.GetHeldEntity () is BaseLiquidVessel baseLiquidVessel && baseLiquidVessel.AmountHeld () > 0;
	}
}
