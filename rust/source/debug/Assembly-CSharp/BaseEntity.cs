...
public class BaseEntity : BaseNetworkable, IOnParentSpawning, IPrefabPreProcess
{
	...
	private readonly struct QueuedFileRequest : IEquatable<QueuedFileRequest>
	{
		...
		{
			int num = (((Object)(object)Entity != (Object)null) ? ((object)Entity).GetHashCode () : 0);
	...
	public override bool OnRpcMessage (BasePlayer player, uint rpc, Message msg)
	{
		...
		try {
			...
			if (rpc == 3645147041u && (Object)(object)player != (Object)null) {
				...
				TimeWarning val5 = TimeWarning.New ("SV_RequestFile", 0);
				try {
	...
	protected void SendNetworkUpdate_Flags ()
	{
		...
		try {
			...
			if (subscribers != null && subscribers.Count > 0) {
				...
				val2.PacketID ((Type)23);
				val2.EntityID (net.ID);
				val2.Int32 ((int)flags);
				Profiler.EndSample ();
				Profiler.BeginSample ("SendInfo");
				SendInfo val3 = default(SendInfo);
				((SendInfo)(ref val3))..ctor (subscribers);
				Profiler.EndSample ();
	...
	public void SetParent (BaseEntity entity, uint boneID, bool worldPositionStays = false, bool sendImmediate = false)
	{
		if ((Object)(object)entity != (Object)null) {
			if ((Object)(object)entity == (Object)(object)this) {
				Debug.LogError ((object)("Trying to parent to self " + this), (Object)(object)((Component)this).gameObject);
				return;
			}
			if (HasChild (entity)) {
				Debug.LogError ((object)("Trying to parent to child " + this), (Object)(object)((Component)this).gameObject);
				return;
			}
		}
	...
	public void DoMovingWithoutARigidBodyCheck ()
	{
		if (doneMovingWithoutARigidBodyCheck <= 10) {
			...
			if (doneMovingWithoutARigidBodyCheck >= 10 && !((Object)(object)((Component)this).GetComponent<Collider> () == (Object)null) && (Object)(object)((Component)this).GetComponent<Rigidbody> () == (Object)null) {
				Debug.LogWarning ((object)string.Concat ("Entity moving without a rigid body! (", ((Component)this).gameObject, ")"), (Object)(object)this);
			}
		}
	}
	...
	{
		//IL_0023: Unknown result type (might be due to invalid IL or missing references)
		Debug.Log ((object)string.Concat ("Invalid Position: ", this, " ", ((Component)this).transform.position, " (destroying)"));
		Kill ();
	}
	...
	public BaseCorpse DropCorpse (string strCorpsePrefab)
	{
		...
		if ((Object)(object)baseCorpse == (Object)null) {
			Debug.LogWarning ((object)string.Concat ("Error creating corpse: ", ((Component)this).gameObject, " - ", strCorpsePrefab));
			return null;
		}
		...
		try {
			if (globalBroadcast) {
				...
				if (!baseEntity.IsValid ()) {
					...
					Debug.LogWarning ((object)string.Concat (((Component)this).gameObject, ": has parent id - but couldn't find parent! ", parentEntity));
				}
	...
	public void ForceUpdateTriggers (bool enter = true, bool exit = true, bool invoke = true)
	{
		...
		if (componentInChildren is CapsuleCollider) {
			...
			OBB obb = default(OBB);
			((OBB)(ref obb))..ctor (((Component)this).transform.position, ((Component)this).transform.lossyScale, ((Component)this).transform.rotation, new Bounds (val2.center, val2.size));
			GamePhysics.OverlapOBB<TriggerBase> (obb, list2, 262144, (QueryTriggerInteraction)2);
	...
	public virtual Vector3 GetInheritedDropVelocity ()
	{
		...
		//IL_002c: Unknown result type (might be due to invalid IL or missing references)
		BaseEntity baseEntity = parentEntity.Get (base.isServer);
		return ((Object)(object)baseEntity != (Object)null) ? baseEntity.GetWorldVelocity () : Vector3.zero;
	}
	...
	public Vector3 GetParentVelocity ()
	{
		...
		//IL_0057: Unknown result type (might be due to invalid IL or missing references)
		BaseEntity baseEntity = parentEntity.Get (base.isServer);
		return ((Object)(object)baseEntity != (Object)null) ? (baseEntity.GetWorldVelocity () + (baseEntity.GetAngularVelocity () * ((Component)this).transform.localPosition - ((Component)this).transform.localPosition)) : Vector3.zero;
	}
	...
	public Vector3 GetWorldVelocity ()
	{
		...
		//IL_006e: Unknown result type (might be due to invalid IL or missing references)
		BaseEntity baseEntity = parentEntity.Get (base.isServer);
		return ((Object)(object)baseEntity != (Object)null) ? (baseEntity.GetWorldVelocity () + (baseEntity.GetAngularVelocity () * ((Component)this).transform.localPosition - ((Component)this).transform.localPosition) + ((Component)baseEntity).transform.TransformDirection (GetLocalVelocity ())) : GetLocalVelocity ();
	}
	...
	public bool IsOlderThan (BaseEntity other)
	{
		...
		NetworkableId val = (NetworkableId)(((??)net?.ID) ?? default(NetworkableId));
	...
	{
		BaseEntity baseEntity = GetParentEntity ();
		return (Object)(object)baseEntity != (Object)null && baseEntity.ForceDeployableSetParent ();
	}
