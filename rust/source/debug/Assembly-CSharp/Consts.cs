...
public static class Consts
{
	...
	public static HideFlags ProceduralObjectsHideFlags => ProceduralObjectsVisibleInEditor ? (HideFlags.DontSave | HideFlags.NotEditable) : HideFlags.HideAndDontSave;
}
