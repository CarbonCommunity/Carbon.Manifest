...
internal sealed class ColorGradingRenderer : PostProcessEffectRenderer<ColorGrading>
{
	...
	{
		GraphicsFormat graphicsFormat = GraphicsFormatUtility.GetGraphicsFormat (format, RenderTextureReadWrite.Linear);
		return SystemInfo.IsFormatSupported (graphicsFormat, FormatUsage.Linear);
	}
