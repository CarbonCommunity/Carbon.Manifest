...
public static class EACServer
{
	...
	private static bool CanEnableGameplayData => ConVar.Server.official && ConVar.Server.stats;

	private static bool CanSendAnalytics => CanEnableGameplayData && Interface != null;
