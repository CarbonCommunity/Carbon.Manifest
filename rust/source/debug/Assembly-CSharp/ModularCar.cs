...
public class ModularCar : BaseModularVehicle, TakeCollisionDamage.ICanRestoreVelocity, CarPhysics<ModularCar>.ICar, IVehicleLockUser, VehicleChassisVisuals<ModularCar>.IClientWheelUser
{
	...
	public class SpawnSettings
	{
		...
		public AdminBonus adminBonus = AdminBonus.None;
	}
	...
	private TimeSince timeSinceDeath = default(TimeSince);
	...
	private Vector3 prevCOMMultiplier = default(Vector3);
	...
	{
		return HasAnyEngines () && HasDriverMountPoints () && !IsDead ();
	}
	...
	{
		return HasAnyWorkingEngines () && HasDriver ();
	}
	...
	public override float GetMaxForwardSpeed ()
	{
		...
		float num = maxDriveForce / base.TotalMass * 30f;
