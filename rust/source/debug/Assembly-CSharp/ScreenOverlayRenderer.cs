...
public class ScreenOverlayRenderer : PostProcessEffectRenderer<ScreenOverlay>
{
	...
	public override void Render (PostProcessRenderContext context)
	{
		...
		if (Object.op_Implicit ((Object)(object)TOD_Sky.Instance)) {
			propertySheet.properties.SetVector ("_LightDir", Vector4.op_Implicit (((Component)context.camera).transform.InverseTransformDirection (TOD_Sky.Instance.LightDirection)));
