...
public class ScarecrowBrain : BaseAIBrain
{
	...
	public class ChaseState : BasicAIState
	{
		...
		public override StateStatus StateThink (float delta, BaseAIBrain brain, BaseEntity entity)
		{
			...
			if (useBeanCan && UnityEngine.Time.time >= throwDelayTime && AI.npc_use_thrown_weapons && Halloween.scarecrows_throw_beancans && UnityEngine.Time.time >= ScarecrowNPC.NextBeanCanAllowedTime) {
