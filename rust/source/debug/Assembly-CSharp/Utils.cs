...
public static class Utils
{
	...
	public static float PackToFloat (this Color color, int floatPackingPrecision)
	{
		...
		float num = 0f;
		num += vector.x * (float)floatPackingPrecision * (float)floatPackingPrecision * (float)floatPackingPrecision;
		num += vector.y * (float)floatPackingPrecision * (float)floatPackingPrecision;
		num += vector.z * (float)floatPackingPrecision;
		return num + vector.w;
	}
