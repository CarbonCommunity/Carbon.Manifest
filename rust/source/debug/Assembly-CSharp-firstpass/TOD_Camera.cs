...
public class TOD_Camera : MonoBehaviour
{
	...
	public float NearClipPlane => cameraComponent ? cameraComponent.nearClipPlane : 0.1f;

	public float FarClipPlane => cameraComponent ? cameraComponent.farClipPlane : 1000f;

	public Color BackgroundColor => cameraComponent ? cameraComponent.backgroundColor : Color.black;
