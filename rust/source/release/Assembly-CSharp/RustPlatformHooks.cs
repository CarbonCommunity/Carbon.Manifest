...
public class RustPlatformHooks : IPlatformHooks
{
	...
	public ServerParameters? ServerParameters {
		get {
			...
			return new ServerParameters ("rust", "Rust", 2515.ToString (), ConVar.Server.secure, CommandLine.HasSwitch ("-sdrnet"), iPAddress, (ushort)Net.sv.port, (ushort)ConVar.Server.queryport);
		}
	}
