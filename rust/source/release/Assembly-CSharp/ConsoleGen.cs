...
{
	public static ConsoleSystem.Command[] All = new ConsoleSystem.Command[1090] {
		...
		new ConsoleSystem.Command {
			...
			Variable = false,
			Call = delegate(ConsoleSystem.Arg arg) {
				string rval31 = BradleyAPC.svspawnroadbradley (arg.GetVector3 (0, Vector3.zero), arg.GetVector3 (1, Vector3.zero));
		...
		new ConsoleSystem.Command {
			...
			Variable = false,
			Call = delegate(ConsoleSystem.Arg arg) {
				ServerUsers.User[] rval30 = Admin.Bans ();
		...
		new ConsoleSystem.Command {
			...
			Variable = false,
			Call = delegate(ConsoleSystem.Arg arg) {
				BuildInfo rval29 = Admin.BuildInfo ();
		...
		new ConsoleSystem.Command {
			...
			Variable = false,
			Call = delegate(ConsoleSystem.Arg arg) {
				Admin.PlayerInfo[] rval28 = Admin.playerlist ();
		...
		new ConsoleSystem.Command {
			...
			Variable = false,
			Call = delegate(ConsoleSystem.Arg arg) {
				string rval27 = Admin.teaminfo (arg);
		...
		new ConsoleSystem.Command {
			...
			Variable = false,
			Call = delegate(ConsoleSystem.Arg arg) {
				IEnumerable<Chat.ChatEntry> rval26 = Chat.search (arg);
		...
		new ConsoleSystem.Command {
			...
			Variable = false,
			Call = delegate(ConsoleSystem.Arg arg) {
				IEnumerable<Chat.ChatEntry> rval25 = Chat.tail (arg);
		...
		new ConsoleSystem.Command {
			...
			Variable = false,
			Call = delegate(ConsoleSystem.Arg arg) {
				IEnumerable<Output.Entry> rval24 = Console.search (arg);
		...
		new ConsoleSystem.Command {
			...
			Variable = false,
			Call = delegate(ConsoleSystem.Arg arg) {
				IEnumerable<Output.Entry> rval23 = Console.tail (arg);
		...
		new ConsoleSystem.Command {
			...
			Variable = false,
			Call = delegate(ConsoleSystem.Arg arg) {
				string rval20 = Entity.svspawn (arg.GetString (0), arg.GetVector3 (1, Vector3.zero), arg.GetVector3 (2, Vector3.zero));
		...
		new ConsoleSystem.Command {
			...
			Variable = false,
			Call = delegate(ConsoleSystem.Arg arg) {
				string rval19 = Entity.svspawngrid (arg.GetString (0), arg.GetInt (1, 5), arg.GetInt (2, 5), arg.GetInt (3, 5));
		...
		new ConsoleSystem.Command {
			...
			Variable = false,
			Call = delegate(ConsoleSystem.Arg arg) {
				string rval18 = Entity.svspawnitem (arg.GetString (0), arg.GetVector3 (1, Vector3.zero));
