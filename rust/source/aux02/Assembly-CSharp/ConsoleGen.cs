...
{
	public static ConsoleSystem.Command[] All = new ConsoleSystem.Command[1100] {
		new ConsoleSystem.Command {
			...
			ServerAdmin = true,
			Variable = true,
			GetOveride = () => AdventCalendar.overrideAdventCalendarDay.ToString (),
		...
		new ConsoleSystem.Command {
			...
			ServerAdmin = true,
			Variable = true,
			GetOveride = () => AdventCalendar.overrideAdventCalendarMonth.ToString (),
			SetOveride = delegate(string str) {
		...
		new ConsoleSystem.Command {
			...
			Variable = false,
			Call = delegate(ConsoleSystem.Arg arg) {
				string rval33 = BradleyAPC.svspawnroadbradley (arg.GetVector3 (0, Vector3.zero), arg.GetVector3 (1, Vector3.zero));
		...
		new ConsoleSystem.Command {
			...
			Variable = false,
			Call = delegate(ConsoleSystem.Arg arg) {
				ServerUsers.User[] rval32 = Admin.Bans ();
		...
		new ConsoleSystem.Command {
			...
			Variable = false,
			Call = delegate(ConsoleSystem.Arg arg) {
				BuildInfo rval31 = Admin.BuildInfo ();
		...
		new ConsoleSystem.Command {
			...
			Variable = false,
			Call = delegate(ConsoleSystem.Arg arg) {
				Admin.PlayerInfo[] rval30 = Admin.playerlist ();
		...
		new ConsoleSystem.Command {
			...
			Variable = false,
			Call = delegate(ConsoleSystem.Arg arg) {
				string rval29 = Admin.teaminfo (arg);
		...
		new ConsoleSystem.Command {
			...
			Variable = false,
			Call = delegate(ConsoleSystem.Arg arg) {
				IEnumerable<Chat.ChatEntry> rval28 = Chat.search (arg);
		...
		new ConsoleSystem.Command {
			...
			Variable = false,
			Call = delegate(ConsoleSystem.Arg arg) {
				IEnumerable<Chat.ChatEntry> rval27 = Chat.tail (arg);
		...
		new ConsoleSystem.Command {
			...
			Variable = false,
			Call = delegate(ConsoleSystem.Arg arg) {
				IEnumerable<Output.Entry> rval26 = Console.search (arg);
		...
		new ConsoleSystem.Command {
			...
			Variable = false,
			Call = delegate(ConsoleSystem.Arg arg) {
				IEnumerable<Output.Entry> rval25 = Console.tail (arg);
		...
		new ConsoleSystem.Command {
			...
			Variable = false,
			Call = delegate(ConsoleSystem.Arg arg) {
				string rval24 = Debugging.testTutorialCinematic (arg);
		...
		new ConsoleSystem.Command {
			...
			Variable = false,
			Call = delegate(ConsoleSystem.Arg arg) {
				string rval21 = Entity.svspawn (arg.GetString (0), arg.GetVector3 (1, Vector3.zero), arg.GetVector3 (2, Vector3.zero));
		...
		new ConsoleSystem.Command {
			...
			Variable = false,
			Call = delegate(ConsoleSystem.Arg arg) {
				string rval20 = Entity.svspawngrid (arg.GetString (0), arg.GetInt (1, 5), arg.GetInt (2, 5), arg.GetInt (3, 5));
		...
		new ConsoleSystem.Command {
			...
			Variable = false,
			Call = delegate(ConsoleSystem.Arg arg) {
				string rval19 = Entity.svspawnitem (arg.GetString (0), arg.GetVector3 (1, Vector3.zero));
		...
		new ConsoleSystem.Command {
			...
			ServerAdmin = true,
			Variable = true,
			GetOveride = () => Global.job_system_threads.ToString (),
			SetOveride = delegate(string str) {
		...
		new ConsoleSystem.Command {
			...
			Variable = false,
			Call = delegate(ConsoleSystem.Arg arg) {
				string rval18 = Global.printAllScenesInBuild (arg);
		...
		new ConsoleSystem.Command {
			...
			Variable = false,
			Call = delegate(ConsoleSystem.Arg arg) {
				object rval17 = ConVar.Manifest.PrintManifest ();
		...
		new ConsoleSystem.Command {
			...
			Variable = false,
			Call = delegate(ConsoleSystem.Arg arg) {
				object rval16 = ConVar.Manifest.PrintManifestRaw ();
		...
		new ConsoleSystem.Command {
			...
			Variable = true,
			GetOveride = () => ConVar.Physics.ragdollmode.ToString (),
			SetOveride = delegate(string str) {
				ConVar.Physics.ragdollmode = str.ToInt ();
			}
		},
		new ConsoleSystem.Command {
			Name = "sendeffects",
		...
		new ConsoleSystem.Command {
			...
			Variable = false,
			Call = delegate(ConsoleSystem.Arg arg) {
				string rval15 = Player.createTrophy (arg);
		...
		new ConsoleSystem.Command {
			...
			Variable = false,
			Call = delegate(ConsoleSystem.Arg arg) {
				string rval14 = ConVar.Server.combatlog (arg);
		...
		new ConsoleSystem.Command {
			...
			Variable = false,
			Call = delegate(ConsoleSystem.Arg arg) {
				string rval13 = ConVar.Server.combatlog_outgoing (arg);
		...
		new ConsoleSystem.Command {
			...
			Variable = false,
			Call = delegate(ConsoleSystem.Arg arg) {
				string rval12 = ConVar.Server.netprotocol (arg);
		...
		new ConsoleSystem.Command {
			...
			Variable = false,
			Call = delegate(ConsoleSystem.Arg arg) {
				string rval11 = ConVar.Server.packetlog (arg);
		...
		new ConsoleSystem.Command {
			...
			ServerAdmin = true,
			Variable = true,
			GetOveride = () => ConVar.Server.player_state_cache_size.ToString (),
			SetOveride = delegate(string str) {
		...
		new ConsoleSystem.Command {
			...
			Variable = false,
			Call = delegate(ConsoleSystem.Arg arg) {
				string rval10 = ConVar.Server.printdecryptqueue (arg);
		...
		new ConsoleSystem.Command {
			...
			Variable = false,
			Call = delegate(ConsoleSystem.Arg arg) {
				string rval9 = ConVar.Server.printeyes (arg);
		...
		new ConsoleSystem.Command {
			...
			Variable = false,
			Call = delegate(ConsoleSystem.Arg arg) {
				string rval8 = ConVar.Server.printpos (arg);
		...
		new ConsoleSystem.Command {
			...
			Variable = false,
			Call = delegate(ConsoleSystem.Arg arg) {
				string rval7 = ConVar.Server.printreadqueue (arg);
		...
		new ConsoleSystem.Command {
			...
			Variable = false,
			Call = delegate(ConsoleSystem.Arg arg) {
				string rval6 = ConVar.Server.printrot (arg);
		...
		new ConsoleSystem.Command {
			...
			Variable = false,
			Call = delegate(ConsoleSystem.Arg arg) {
				string rval5 = ConVar.Server.printwritequeue (arg);
		...
		new ConsoleSystem.Command {
			...
			Variable = false,
			Call = delegate(ConsoleSystem.Arg arg) {
				string rval4 = ConVar.Server.readcfg (arg);
		...
		new ConsoleSystem.Command {
			...
			Variable = false,
			Call = delegate(ConsoleSystem.Arg arg) {
				string rval3 = ConVar.Server.rpclog (arg);
		...
		new ConsoleSystem.Command {
			...
			Variable = false,
			Call = delegate(ConsoleSystem.Arg arg) {
				string rval2 = SteamNetworking.steamstatus ();
