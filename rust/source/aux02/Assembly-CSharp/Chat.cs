...
public class Chat : ConsoleSystem
{
	...
	[CompilerGenerated]
	private struct <sayAs>d__19 : IAsyncStateMachine
	{
		public int <>1__state;
			...
			try {
				...
				if (!enabled) {
					...
					if (<strChatText>5__2.Length <= 0) {
						...
						TmProEmojiRedirector.FindEmojiSubstitutions (<strChatText>5__2, RustEmojiLibrary.Instance, list, richText: false, isServer: true);
						bool flag = true;
				...
				IL_01b6:
				if (serverlog) {
					ServerConsole.PrintColoured (ConsoleColor.DarkYellow, "[" + targetChannel.ToString () + "] " + username + ": ", ConsoleColor.DarkGreen, <strChatText>5__2);
					...
					default:
						if ((Object)(object)player != (Object)null && player.clanId != 0L) {
							...
							if (!awaiter2.IsCompleted) {
								num = (<>1__state = 0);
								<>u__1 = awaiter2;
								<>t__builder.AwaitUnsafeOnCompleted<ValueTaskAwaiter<ClanValueResult<IClan>>, <sayAs>d__19> (ref awaiter2, ref this);
								return;
							}
							goto IL_0741;
						}
					...
					case 2:
						...
						if (val2.IsSuccess) {
							...
							if (!awaiter.IsCompleted) {
								num = (<>1__state = 2);
								<>u__2 = awaiter;
								<>t__builder.AwaitUnsafeOnCompleted<ValueTaskAwaiter<ClanResult>, <sayAs>d__19> (ref awaiter, ref this);
								return;
							}
							break;
						}
	...
	[AsyncStateMachine (typeof(<sayAs>d__19))]
	internal static ValueTask<bool> sayAs (ChatChannel targetChannel, ulong userId, string username, string message, BasePlayer player = null)
	{
		...
		<sayAs>d__19 <sayAs>d__ = default(<sayAs>d__19);
		...
		<sayAs>d__.<>t__builder.Start<<sayAs>d__19> (ref <sayAs>d__);
