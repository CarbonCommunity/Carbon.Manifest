...
public class TreeEntity : ResourceEntity, IPrefabPreProcess
{
	...
	public override void OnAttacked (HitInfo info)
	{
		...
		if (treeMarkerData != null) {
			...
			((Line)(ref val12))..ctor (((Component)GetCollider ()).transform.TransformPoint (new Vector3 (0f, 10f, 0f)), ((Component)GetCollider ()).transform.TransformPoint (new Vector3 (0f, -10f, 0f)));
