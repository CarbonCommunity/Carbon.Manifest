	...
	private static bool AnyTextboxFocused ()
	{
		...
		if (current != null) {
			...
			if (currentSelectedGameObject != null) {
				if (currentSelectedGameObject.TryGetComponent<InputField> (out var component) && component.isFocused) {
					return true;
				}
				if (currentSelectedGameObject.TryGetComponent<TMP_InputField> (out var component2) && component2.isFocused) {
					return true;
				}
			}
		}
