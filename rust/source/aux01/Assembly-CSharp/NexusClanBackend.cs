...
public class NexusClanBackend : IClanBackend, IDisposable
{
	...
	public System.Threading.Tasks.ValueTask<ClanValueResult<IClan>> Get (long clanId)
	{
		...
		<Get>d__.<>1__state = -1;
		AsyncValueTaskMethodBuilder<ClanValueResult<IClan>> <>t__builder = <Get>d__.<>t__builder;
		<>t__builder.Start<<Get>d__8> (ref <Get>d__);
	...
	public System.Threading.Tasks.ValueTask<ClanValueResult<IClan>> GetByMember (ulong steamId)
	{
		...
		AsyncValueTaskMethodBuilder<ClanValueResult<IClan>> <>t__builder = <GetByMember>d__.<>t__builder;
		<>t__builder.Start<<GetByMember>d__10> (ref <GetByMember>d__);
	...
	public System.Threading.Tasks.ValueTask<ClanValueResult<IClan>> Create (ulong leaderSteamId, string name)
	{
		...
		AsyncValueTaskMethodBuilder<ClanValueResult<IClan>> <>t__builder = <Create>d__.<>t__builder;
		<>t__builder.Start<<Create>d__11> (ref <Create>d__);
	...
	public System.Threading.Tasks.ValueTask<ClanValueResult<List<ClanInvitation>>> ListInvitations (ulong steamId)
	{
		...
		AsyncValueTaskMethodBuilder<ClanValueResult<List<ClanInvitation>>> <>t__builder = <ListInvitations>d__.<>t__builder;
		<>t__builder.Start<<ListInvitations>d__12> (ref <ListInvitations>d__);
