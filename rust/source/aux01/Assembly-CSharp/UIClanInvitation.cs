...
public class UIClanInvitation : BaseMonoBehaviour, IUIPlayerRefreshCallback
{
	...
	public static readonly Translate.Phrase AcceptInvitationFull = new TokenisedPhrase ("clan.accept_invitation.fail", "Cannot accept this clan invitation because the clan is full.");
