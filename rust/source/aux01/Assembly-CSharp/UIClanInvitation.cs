...
public class UIClanInvitation : BaseMonoBehaviour, IUIPlayerRefreshCallback
{
	...
	public static readonly Phrase AcceptInvitationFull = (Phrase)(object)new TokenisedPhrase ("clan.accept_invitation.fail", "Cannot accept this clan invitation because the clan is full.");
