...
public class App : ConsoleSystem
{
	...
	[CompilerGenerated]
	private struct <GetPublicIPAsync>d__19 : IAsyncStateMachine
	{
		public int <>1__state;
			...
			try {
				...
				if (!num2 && (string.IsNullOrWhiteSpace (publicIP) || !(publicIP != "0.0.0.0"))) {
					...
					if (!awaiter.IsCompleted) {
						num = (<>1__state = 0);
						<>u__1 = awaiter;
						<>t__builder.AwaitUnsafeOnCompleted<TaskAwaiter, <GetPublicIPAsync>d__19> (ref awaiter, ref this);
						return;
					}
					goto IL_00cc;
				}
	...
	[AsyncStateMachine (typeof(<GetPublicIPAsync>d__19))]
	public static System.Threading.Tasks.ValueTask<string> GetPublicIPAsync ()
	{
		...
		<GetPublicIPAsync>d__19 <GetPublicIPAsync>d__ = default(<GetPublicIPAsync>d__19);
		<GetPublicIPAsync>d__.<>t__builder = AsyncValueTaskMethodBuilder<string>.Create ();
		<GetPublicIPAsync>d__.<>1__state = -1;
		AsyncValueTaskMethodBuilder<string> <>t__builder = <GetPublicIPAsync>d__.<>t__builder;
		<>t__builder.Start<<GetPublicIPAsync>d__19> (ref <GetPublicIPAsync>d__);
