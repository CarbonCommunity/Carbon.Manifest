...
public class GenerateDungeonGrid : ProceduralComponent
{
	...
	public override void Process (uint seed)
	{
		if (World.Cached) {
			...
			Prefab<DungeonGridCell>[] array3 = Prefab.Load<DungeonGridCell> ("assets/bundled/prefabs/autospawn/" + TransitionFolder, null, null, useProbabilities: true, useWorldConfig: false);
			if (array3 == null) {
				return;
			}
			Prefab<DungeonGridLink>[] array4 = Prefab.Load<DungeonGridLink> ("assets/bundled/prefabs/autospawn/" + LinkFolder, null, null, useProbabilities: true, useWorldConfig: false);
			if (array4 == null) {
				return;
			}
